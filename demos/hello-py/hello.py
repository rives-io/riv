...
riv_draw_text = libriv.func("v", "riv_draw_text", "psLillll")

while True:
  riv_clear(RIV_COLOR_BLACK)
  riv_draw_text(bytearray(32), "hello world!", RIV_SPRITESHEET_FONT_5X7, RIV_CENTER, 128, 128, 2, RIV_COLOR_WHITE)
  if not riv_present():
    break
